...
*  Copyright notice
*
*  (c) 2005-2005 Ingo Schmitt <is@marketing-factory.de>
*  All rights reserved
*
...
***************************************************************/
/**
 * COMMERCE Coupons edit nav frame.
 ...
 * 
 */
class tx_commerce_coupons_navframe {
	...
	function init()	{
		...
		$this->pagetree->thisScript = $BACK_PATH.TYPO3_MOD_PATH.'class.tx_commerce_coupons_navframe.php';
...
#		$this->settingTemporaryMountPoint(11);
			// Temporary DB mounts:
		$this->pagetree->MOUNTS=array_unique(tx_graytree_folder_db::initFolders('Coupons','Commerce',0,'Commerce'));
	...
	function main()	{
		...
		$tree = $this->pagetree->getBrowsableTree();
			...
			// Start page:
		$this->content = '';
		$this->content.= $this->doc->startPage('Coupons');
	...
	function initializeTemporaryDBmount(){
		...
		$temporaryMountPoint = intval($BE_USER->getSessionData('pageTree_temporaryMountPoint_coupons'));
	...
	function settingTemporaryMountPoint($pageId)	{
		...
		$BE_USER->setAndSaveSessionData('pageTree_temporaryMountPoint_coupons',intval($pageId));
	}
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce_coupons/mod_coupons/class.tx_commerce_coupons_navframe.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce_coupons/mod_coupons/class.tx_commerce_coupons_navframe.php']);
}

// Make instance:

$SOBE = t3lib_div::makeInstance('tx_commerce_coupons_navframe');
$SOBE->init();
$SOBE->main();
$SOBE->printContent();
