...
require_once (PATH_txcommerce.'lib/class.tx_commerce_order_localrecordlist.php');
...
class tx_commerce_coupons extends t3lib_SCbase {
	...
	var $table ='tx_commerce_coupons';					// Which table to make extended listing for
	...
	function init()	{
		...
		parent::init();
		$this->table='tx_commerce_coupons';
